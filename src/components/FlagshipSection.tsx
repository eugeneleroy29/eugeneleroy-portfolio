...
export function FlagshipSection() {
  return (
    <section id="flagship" className="py-12 border-b border-zinc-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Spotlight Card */}
        <div className="relative rounded-3xl bg-gradient-to-br from-indigo-950/40 via-zinc-900/80 to-zinc-950 border border-indigo-500/30 p-6 md:p-8 overflow-hidden shadow-2xl">
